...
namespace HAL
{
    class HalCardputer : public Hal
    {
        ...
        public:
            ...
            void init() override;
            void playKeyboardSound() override { _speaker->setChannelVolume(TONE_CHANNEL, 72); _speaker->tone(5000, 20, TONE_CHANNEL); }
            void playLastSound() override { _speaker->setChannelVolume(TONE_CHANNEL, 32); _speaker->tone(6000, 20, TONE_CHANNEL); }
            void playNextSound() override { _speaker->setChannelVolume(TONE_CHANNEL, 64); _speaker->tone(7000, 20, TONE_CHANNEL); }
